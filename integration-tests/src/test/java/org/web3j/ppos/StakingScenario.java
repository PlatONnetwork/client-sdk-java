...
public class StakingScenario extends Scenario {
    ...
    public void transfer() throws Exception {
        Transfer.sendFunds(web3j, superCredentials, chainId, stakingCredentials.getAddress(chainId), transferValue, Unit.LAT).send();
        Transfer.sendFunds(web3j, superCredentials, chainId, delegateCredentials.getAddress(chainId), transferValue, Unit.LAT).send();
    }
