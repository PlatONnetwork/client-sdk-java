...
public class ProposalContractTest {
    ...
    public void transfer() throws Exception {
    	Transfer.sendFunds(web3j, superCredentials, chainId, stakingCredentials.getAddress(chainId), new BigDecimal("10000"), Unit.ATP).send();
    	System.out.println("stakingCredentials balance="+ web3j.platonGetBalance(stakingCredentials.getAddress(chainId), DefaultBlockParameterName.LATEST).send().getBalance());
    }
    ...
    public void submitTextProposal() {
        try {
            ...
            System.out.println("提案id："+platonSendTransaction.getTransactionHash());
    ...
    public void voteForProposal(String proposalID) {
        vote(proposalID,
        		...
        		"http://192.168.120.141:6789", VoteOption.YEAS);
        ...
        vote(proposalID,
        		...
        		"http://192.168.120.142:6789", VoteOption.YEAS);
        ...
        vote(proposalID,
        		...
        		"http://192.168.120.143:6789", VoteOption.YEAS);
        ...
        vote(proposalID,
        		...
        		"http://192.168.120.144:6789", VoteOption.YEAS);
    }
    ...
    public void queryResult() {
        try {
        	queryResult("0x67e7e1ae39952cc0f9016e9865291defeb92dc7c5a3cda799f452219473d29dc");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
