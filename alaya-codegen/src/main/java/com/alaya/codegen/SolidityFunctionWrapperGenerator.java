...
public class SolidityFunctionWrapperGenerator extends FunctionWrapperGenerator {
	...
	private static final String USAGE = "solidity generate " + "[--javaTypes|--solidityTypes] " + "<input binary file>.bin <input abi file>.abi "
	...
	private SolidityFunctionWrapperGenerator(String binaryFileLocation, String absFileLocation, String destinationDirLocation, String basePackageName,
	...
	public static void main(String[] args) throws Exception {
		...
		new SolidityFunctionWrapperGenerator(binaryFileLocation, absFileLocation, destinationDirLocation, basePackageName, useJavaNativeTypes)
				.generate();
	}
