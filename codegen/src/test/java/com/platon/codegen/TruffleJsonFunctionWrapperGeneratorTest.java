...
public class TruffleJsonFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGenerationJvmTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, PackageName, com.platon.codegen.FunctionWrapperGenerator.JAVA_TYPES_ARG);
    ...
    private void testCodeGenerationSolidtyTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, PackageName, com.platon.codegen.FunctionWrapperGenerator.SOLIDITY_TYPES_ARG);
    ...
    private void testCodeGeneration(
        ...
        com.platon.codegen.TruffleJsonFunctionWrapperGenerator.main(Arrays.asList(
                types,
