...
import static com.platon.codegen.SolidityFunctionWrapper.*;
...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    private com.platon.codegen.SolidityFunctionWrapper solidityFunctionWrapper;

    private com.platon.codegen.GenerationReporter generationReporter;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        generationReporter = mock(com.platon.codegen.GenerationReporter.class);
        solidityFunctionWrapper = new com.platon.codegen.SolidityFunctionWrapper(true, generationReporter);
    }
