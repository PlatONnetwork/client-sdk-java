...
public class ProposalScenario extends Scenario {
    ...
    public void transfer() throws Exception {
        Transfer.sendFunds(web3j, superCredentials, chainId, proposalCredentials.getAddress(chainId), transferValue, Unit.ATP).send();
        Transfer.sendFunds(web3j, superCredentials, chainId, voteCredentials.getAddress(chainId), transferValue, Unit.ATP).send();
    }
