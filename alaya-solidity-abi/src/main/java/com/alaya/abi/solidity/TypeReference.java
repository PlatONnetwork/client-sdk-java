 ...
 */
public abstract class TypeReference<T extends com.alaya.abi.solidity.datatypes.Type>
    ...
    public static <T extends com.alaya.abi.solidity.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.alaya.abi.solidity.datatypes.Type>
