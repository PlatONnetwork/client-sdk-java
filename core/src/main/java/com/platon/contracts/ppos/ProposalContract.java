...
public class ProposalContract extends BaseContract {
    ...
    public static ProposalContract load(Web3j web3j) {
        return new ProposalContract(NetworkParameters.getPposContractAddressOfProposal(), web3j);
    }
    ...
    public static ProposalContract load(Web3j web3j, TransactionManager transactionManager) {
    	return new ProposalContract(NetworkParameters.getPposContractAddressOfProposal(), web3j, transactionManager);
    }
    ...
    public static ProposalContract load(Web3j web3j, Credentials credentials) {
        return new ProposalContract(NetworkParameters.getPposContractAddressOfProposal(), web3j, credentials);
    }
