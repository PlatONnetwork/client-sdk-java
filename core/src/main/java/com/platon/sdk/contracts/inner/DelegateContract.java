...
public class DelegateContract extends BaseContract {
     ...
     * @return
     */
    public RemoteCall<TransactionResponse> getDelegateResult(PlatonSendTransaction ethSendTransaction) {
     ...
     * @return
     */
    public RemoteCall<TransactionResponse> getUnDelegateResult(PlatonSendTransaction ethSendTransaction) {
        return executeRemoteCallTransactionStep2(ethSendTransaction);
    }
